...
export default function HomePage() {
  return (
    <main className="min-h-dvh bg-gray-100 text-foreground">
      <div className="relative mx-auto flex min-h-dvh w-full max-w-[395px] flex-col overflow-hidden bg-background px-6 pb-[calc(126px+env(safe-area-inset-bottom))] pt-[62px]">
